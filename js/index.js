...
const render = () => {
    ...
    const [day3, hours3, minutes3, seconds3] = calculate(new Date("2023-12-24T08:30+09:00"));
    ...
    clock3.innerHTML = `그가 집에 가는 날까지 ${day3}일 ${hours3}시간 ${minutes3}분 ${seconds3}초 남았습니다.`;
}
